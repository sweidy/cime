...
project = u'CIME with documentation about the Replay'
copyright = u'2017, U.S. National Science Foundation and U.S. Department of Energy'
author = u'CIME: Staff of the NSF/CESM and DOE/E3SM projects. Replay: Sarah Weidman'
...
version = u'cime5.6.replay'
# The full version, including alpha/beta/rc tags.
release = u'cime5.6.replay'
